...
<body>
    <form id="login-form" method='post' action="{$login_url}" onsubmit="return checkForm('login-form');">
        <span><h2>登录</h2></span>
        <p>账号：<input type="text" name="name"></p>
        <p><span id="name-error-message" style="color: red;"></span></p>
        <p>密码：<input type="text" name="password"></p>
        <p><span id="password-error-message" style="color: red;"></span></p>
        <input type="button" value="注册" onclick="javascript:window.location.href='{$register_url}'">
        <button>提交</button>
    </form>
</body>
</html>
